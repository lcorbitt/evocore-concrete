...
const toggleButtonClass =
  "relative z-[60] inline-flex size-10 shrink-0 items-center justify-center rounded-md border border-evocore-grey/60 bg-evocore-black/80 text-evocore-white transition-colors hover:border-evocore-red/60 hover:bg-evocore-steel/90 hover:text-evocore-red focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-evocore-red";
...
const linkClass =
  "font-label border-b border-evocore-grey/50 py-4 text-base font-semibold uppercase tracking-widest text-evocore-white transition-colors hover:border-evocore-red hover:text-evocore-red focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-evocore-red";

const barBase =
  "absolute left-1/2 block h-0.5 w-5 -translate-x-1/2 rounded-full bg-white transition-all duration-300 ease-in-out will-change-transform";
